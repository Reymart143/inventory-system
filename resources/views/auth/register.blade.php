                ...
                <div class="card z-index-0 fadeIn3 fadeInBottom">
                  <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-success shadow-success border-radius-lg py-3 pe-1 text-center">
                      ...
                      <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Registeration Portal</h4>
                      <div class="row mt-3"></div>
                    </div>
                  </div>
                  <div class="card-body">
                    <form class="text-start" method="POST" action="{{ route('auth.register')}} ">
                      @csrf
                      ...
                      <div class="row mb-3">
                        <div class="col-md-6">
                          <div class="input-group input-group-outline">
                            ...
                            <input type="text" id="number" name="number" class="form-control" value="{{ old('number') }}" oninput="this.value = this.value.replace(/[^0-9+]/g, '');" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="input-group input-group-outline">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-check form-check-inline ms-0 mb-3 me-1">
                            <input class="form-check-input ms-0" type="checkbox" id="showPassword">
                            <label class="form-check-label" for="showPassword">Show Password</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-check form-check-inline mb-3 ms-0 me-1">
